...
def build_case_metrics(summary: dict[str, Any]) -> dict[str, dict[str, Any]]:
    ...
    for run in summary["runs"]:
        ...
        cases[label] = {
            ...
            "runtime_basis": benchmark_summary.get("runtime_basis"),
            ...
            "avg_solver_runtime_seconds": benchmark_summary.get("avg_solver_runtime_seconds"),
            "max_solver_runtime_seconds": benchmark_summary.get("max_solver_runtime_seconds"),
