...
from .propagation import PropagationMode, propagate_cp_node
...
def cp_full_propagation_mode(time_limit: float) -> PropagationMode:
...
def solve_cp(
    ...
    try:
        ...
        if pairwise_reason is not None:
            ...
            return SolveResult(
                ...
                restarts=0,
                metadata={"backend": "cp_full", "reason": pairwise_reason, "seed": seed, "time_limit": time_limit},
            )
        ...
        return SolveResult(
            ...
            restarts=0,
            metadata={"backend": "cp_full", "reason": str(exc), "seed": seed, "time_limit": time_limit},
        )
    ...
    budget_mode = cp_budget_mode(time_limit)
    propagation_mode = cp_full_propagation_mode(time_limit)
